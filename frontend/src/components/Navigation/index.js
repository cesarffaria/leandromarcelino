    ...
    <Navbar bg="" variant="dark">
      <Container>
        <Nav className="mr-auto">
          ...
          <ul className="social-list"><li><a href="https://www.facebook.com/LM-Instala%C3%A7%C3%B5es-Eletricas-110138071688000" target="_blank"><img src={logoF} alt="F" width="10" height="18"/></a></li><li><a href="https://www.linkedin.com/company/lm-instala%C3%A7%C3%B5es-el%C3%A9tricas/" target="_blank"><img src={logoIN} alt="in" width="20" height="20"/></a></li></ul>
        </Nav>
      </Container>
    </Navbar>
  );
